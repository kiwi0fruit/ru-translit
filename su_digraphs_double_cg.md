...
Новые буквы: áàóòýỳúùéèìíẁćčśšǧ (18 - ÁÀÓÒÝỲÚÙÉÈÌÍẀĆČŚŠǦ). Ударения: âǎôǒêěûǔîŵǐĉĵŷy̌b̂ ÂǍÔǑÊĚÛǓÎŴǏĈĴŶY̌B̂. То есть, алфавит состоит из 26 букв базовой латиницы и четырёх диакритических знаков (акут, гравис, крышечка, гачек). 
...
щ - sch (shch),  
сч - sch (sčh / ssch) - если раздельное чтение, то sòch,  
...
* Aa, Àà (Аа) => Ââ (Àà - отдельная от диграфов Аа после гласных или модифицирующая J,B,...)
* Áá (Яя) => Ǎǎ
* Uu, Ùù (Уу) => Ûû (Ùù - отдельная от диграфов Уу после гласных или модифицирующая J,B,...)
* Úú (Юю) => Ǔǔ
* Oo, Òò, Óó (Оо) => Ôô (Òò - отдельная от диграфов Оо после гласных, Óó - модифицирующая J,B,...)
* ÉOéo (Ёё) => ÉǑéǒ
* Òò (Ъъ) — doesn't need (Òò - значит Ъъ после согласных, но не после Jj)
* Ee, Èè (Ээ) => Êê (Èè - отдельная от диграфов Ээ после гласных)
* Ee, Éé, Èè (Ее) => Ěě (Èè - модифицирующая J,B,...)
* Éé (Ьь) — doesn't need (Éé - значит Ьь после согласных, но не после Jj)
* Yy (Ыы) => Ŷŷ
* Ýý, Ỳỳ (Ии) => Y̌y̌ / yî (Ýý - Ии греческой этимологии, Ỳỳ - модифицирующая J,B,...)
* I i, Í í, Ì ì (Ии) => Ǐ ǐ ( Ì ì - модифицирующая J,B,...)
