...
Дополнительные кнопки у них помечены:  
' - адаптировать для имитации кнопки ' " из US-int. - есть и в Кечуа, и в Пурепеча.  
Ïï - адаптировать для имитации кнопки \`~ из US-int. - есть только в Пурепеча.  
