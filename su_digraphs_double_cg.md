...
Выбранная диакритика при наборе с помощью EurKey на PC и Gboard на Андроиде будет использовать следующие буквы (несоответствие Ğ и Ǧ, видимо, неизбежно на первом этапе):
