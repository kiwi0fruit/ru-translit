# Русская латиница "Латинский OK симулякр"

Радикально эимологическая латиница с кучей омофонов. Целью было приблизить правила написания к латинским и английским. Но при этом, правила чтения слов едины и не меняются от слова к слову. Для совместимости с кириллицей аббревиатуры строятся фонетически (как в OK - all correct).

Новая версия на основе [**предыдущей**](https://github.com/kiwi0fruit/ru-translit/blob/main/su_en.md). Являет собой дуальную ASCII-only и диакритическую версии, совместимые между собой. То есть, например, слово из ASCII версии будет значить тоже самое в диакритической версии. Слова, не представимые в кириллице, не являются частью латиницы.
...
Новые буквы: áàóòýỳúùéèìíẁćčśšǧ (18 - ÁÀÓÒÝỲÚÙÉÈÌÍẀĆČŚŠǦ). Ударения: âǎôǒêěûǔî ǐŵĵŷy̌ãõẽũỹ ĩ ÂǍÔǑÊĚÛǓÎ ǏŴĴŶY̌ÃÕẼŨỸ Ĩ. То есть, алфавит состоит из 26 букв базовой латиницы и 5 диакритических знаков (акут, гравис, крышка, гачек, тильда). 
...
дж - g[èìỳ] / gjh - где этимология требует g - но не после d (Gèorgjh / Gjhyorgjh Джордж, Gìuljetta / Gjhuljetta, Gìovanni / Gjhovanni, gìn / gjhin / джин, Gèòrgjh / Gjheorgjh / Джеордж, Energỳ / Energjhy Энерджи),  
дж - jae, j[èìóàùỳh] / jh - где этимология требует - но не после d,g (Jaejms, Jàems / Jhaaems Джаэмс, Jàrmush, jìnsy, Jaeck, Jèrsý, hajjh, jóker, ỳjỳd / yyjhyd ыджыд - альтернативный вариант),  
дж - djae, dj[èìóàùỳh] / djh - где этимология требует dj,  
...
х - ch[\c][èìóàùỳ] / kh[\c][eioauy] - перед согласной+гласной где этимология требует ch или kh (Chrìstos, Lochnèss / Lokhness, Loćhnèss / Lokhnuess (Lochònèss если знать где стык словообразования), Loćhnaess / Lokhnaess (Lochònaes), Ločhnèss / Lochnuess Лочнэс (Lochénèss), buchghàlter, chtónichescyj хтонический, chtèonichescyj хтёнический),  
...
*(Специальные комбинации, чьё звучание изменяется буквами èìóàùỳ: b,ch,j,dj,g,dg),*  
...
я - á / ja - после й, после "и" в окончаниях (Mariá / Marija, allilujá / allilujja, sijaté - не окончание),  
...
Изменения в названиях букв и диграфов:

* Kk - ка
* Cc, Ćć - це (C., ĆPU, перед EÉI в аббревиатурах - просто C)
* Yy - игрек, в аббр. - игр
* Ỳỳ - ы
* Qq - ку
* Hh - ха (H., KHL, была "аш")
* Xx - икс
* Jj - йот (была "жи" / и-краткая)
* W - дубль-вэ, в аббр. - ву
* Gg - гэ (была "же")
* Zz - зэт, в аббр. - зэ (была "зэ")
* Ll - эль, в аббр. - эл
* Áá - я
* ÉÓéó - ё
* Úú - ю
* Ee, Éé - е (E., ÉGÈ, после согласных в аббр. - просто E)
* Èè - э (È., ÉGÈ)
* Sh, Šš - ша (Sh., VŠ)
* Sch, Śś - ща (Sch., MŚ)
* Ch, Čč - че (Ch., ČS)
...
|   A    |       O        |    U    |  È (Eh) |  Ỳ (Yh) |
| **Я**  |     **Ё**      |  **Ю**  | **Е**  |  **И**  |
| Á (JA) |    ÉÓ / EÓ (JEo / Eo)     |  Ú (JU) | E / É (JE) |  I  |
| **Б**  |     **В**      |  **Г**  | **Д**  |  **Ж**  |
|   B    |       V        | G   |   D    |   Ǧ (Gj)    |
| **З**  |     **Й**      |  **К**  | **Л**  |  **М**  |
|   Z    |     J / JI     |    K    |   L    |    M    |
...
|   N    |       P        |    R    |   S    |    T    |
| **Ф**  |     **Х**      |  **Ц**  | **Ч**  |  **Ш**  |
|   F    |       H        |    C / Ć (Cj)    |  Č (Ch)    |   Š (Sh)    |
| **Щ**  |     **ШЧ, СЧ**     |  **ГЫ**       |        |         |
| Ś (Sch) |  ŠČ, SČ (ShCh, SCh)      |  GỲ / GYh       |        |         |
...
* в аббревиатуры и инициалы Ц (C..., Tç..., Ç...) идет всегда как C. И читается как "Це" (CRU ЦРУ, CA ЦА),
* в аббревиатуры и инициалы Ха (H..., Çh...) идёт всегда как H: NHL, KHL, NGAHA, Heljga => H., Çhristos => H.,
* в аббревиатуры ph и f всегда идут как F: FD aka' photodiod,
* буквы Cc называется Це, буква Yy называется Игрек,
...
Интересными раскладками в GBoard, имеющими ровно одну дополнительную клавишу для ' и \`, являются следующие: Валлийский, Хауса (могут интегрироваться с английским - на них будут подсказки и свайп англиских слов) и Бенч (может печатать ěǎǔǒǐ). При этом, валлийский может печатать ỳẁ. Остальные найденные не столь хороши: Южно-боливийский кечуа (без поддержки swype), Пурепеча, Кечуа (могут набирать Çç), Покот, Хилигайнон (ничем не примечательны).
...
Выбранная диакритика при наборе с помощью EurKey на PC и Gboard на Андроиде с раскладкой эсперанто будет использовать следующие буквы в **аббревиатурах** (несоответствие Ğ и Ǧ, видимо, неизбежно на первом этапе):
...
*Требуется полная ревизия этого раздела из-за выбранного способа ввода на смартфоне.*
...
На данный момент это, а так же заимствования с ya,yo,yu после согласных - единственные расхождения.
...
V pjese pro devushcu v zeléonom platjíce vse sadilisé na ladjí I plyli po recè. No tut iz lesa vyshel Gèorgjh Maximus, coné v paléto I rvanyh djìnsah, cotoryj cogo-to obìscyval, I pricazal vsem mytésá I gotovité buljon. Znachit snova pjeom do lysyh aqvalangistov.
