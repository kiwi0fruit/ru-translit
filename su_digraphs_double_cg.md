...
Так что Валлийский из GBoard - идеальный кандидат для переделки в аналог US-international. А Бенч можно добавить для ударений.

Если же Вы предпочитаете клавиатуры с открытым исходным кодом, то придется пропатчить и скомпилировать OpenBoard.

Выбранная диакритика при наборе с помощью EurKey на PC и Gboard на Андроиде будет использовать следующие буквы в **аббревиатурах** (несоответствие Ğ и Ǧ, видимо, неизбежно на первом этапе):
