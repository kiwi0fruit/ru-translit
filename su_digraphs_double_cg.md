...
* Ee, Èè (Ээ) => Êê (Èè - отдельная от диграфов Ээ или когда после дж-j-dg)
* Ee, Éé (Ее) => Ěě
* Éé (Ьь) — doesn't need (Éé - значит Ьь после согласных, но не после Jj)
* Uu, Ùù (Уу) => Ûû (Ùù - отдельная от диграфов Уу)
* Úú (Юю) => Ǔǔ
* Yy (Ыы) => Ŷŷ
* Ýý (Ии) => Y̌y̌ / yî (Ýý - Ии греческой этимологии, Y̌y̌ использует комбинированные символы)
...
Под ударением: sýstem => syîstem, vyíscyvaté => vyǐscyvaté, obìsc => obîsc, Ẁest / Уэст => Ẁêst / Уэ́ст, Ŵest / У́эст.
