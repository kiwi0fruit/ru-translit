...
ц - ц[яюь] — *не поддерживается* - где этимология требует t, но не в начале слова (милиць - не поддерживается),  
...
* в аббревиатуры Ц идет всегда как C. И читается как "Це" (CRU ЦРУ, CA ЦА),
* в аббревиатуры Х идёт всегда как H: NHL, KHL, NGAHA, Heljga => H., Çhristos => H.,
