...
жж - gzz (gzugzzit),  
ж - gz - обычно (gzuc),  
з - sz - после кцжст или где этимология требует "s" (ecszema, muszyca, sszadi, otszyv),  
з - z - обычно (zabor),  
х - çh / kh - после согласных или где этимология требует ch или kh (sçhod / skhod, çhimera / khimera),  
х - h - обычно (hoholoc),  
чч - cch (capricchio),  
ч - ch (chto),  
...
и - î / yi - после согласной+й (superjîppi / superjyippi суперйиппи),  
...
* передыдущая буква перед И/I пишется капсом (CHI, CZI, CKI, SÇI / ShcHI),
* везде, где можно прочитать неправильно, добавлять полную форму буквы,
* опционально можно сокращать sZ, Ck и ÇH/kH до 'Z, C', 'H,
* перед "ЭИЫЙ,ЕЁЮЯ,З" в аббревиатурах используются К/Ck (в общем, везде, где можно прочитать неправильно),
...
SÇHI S'HI СХИ (SkHI),  
ÉGÊ ЕГЭ (JEGE),  
ГЕ/GÉ (GJE), ГЭ/GÊ (GE), ГИ/GI, ГЫ/GY, ГЗ/GsZ/G'Z,  
ЖЕ/GzÉ (GzJE), ЖЭ/GzÊ (GzE), ЖИ/GZI, ЖЫ/GzY,  
КЕ/CkÉ/C'É (CkJE), КЭ/CkÊ/C'Ê (CkE), КИ/CKI/C'I, КЫ/CkY/C'Y, КЗ/CsZ/C'Z,  
