...
* после строчных букв I всегда пишется как Ï (только когда после нет других согласных букв кроме I): ChÏ (ChI), ChIÏ (ChII),
...
* не должно быть неоднозначностей когда все капсом. А смешанный регистр предотвращает смешение в диграфы - его можно.
