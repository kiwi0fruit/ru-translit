...
* **e** после согласных всегда смягчает, можно опустить i (пень/penj). sie и se значат одно и то же, но первый вариант не используется за избыточностью. В остальных случаях **e** обозначает звук э (это/eto, поэт/poet). Йотировать надо для уезд/ujezd.
* Убрать смягчение после согласной можно с помощью **ye** (мэр/myer, сэр/syer). sya и sa значат одно и то же (как и syu/su, syo/so), но первый вариант не используется за избыточностью. **yy** используется аналогично случаю с "и" после согласных перед не йотированными гласными (сыо/syyo).
