...
*По-моему, это вариант гораздо лучше подходит для русско-английских билингвов, чем варианты с диакритическими знаками. В английском не диакритики, в русском - почти нет (ё никто не ставит, оставшуюся й трудно считать диакритикой). Так что не удивительно, что она будет вызывать отторжение.*
...
|        | Cyrillic RegEx | Latin RegEx   | Примеры                                                                            |
| ------ | ------------:|:------------- | ---------------------------------------------------------------------------------- |
| проект/.../we | `проект`&#124;`...` | `we` | про**е**кт/pro**we**kt (слова, которые должны были быть с `ye`, но произносятся с **ударным** "э") |
