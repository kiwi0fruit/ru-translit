...
* dzh => dž (дж),
* cz => ç (ц),
* добавлены новые буквы Àà, Òò, Ùù, Ìì, Įį, Ėė, Çç, Ŝŝ, Ĵĵ, Žž, Ɂɂ, и убраны Xx, Ww, Qq,
* отличия аббревиатур описаны отдельно (ещё новые буквы: Èè, Šš, Ĥĥ),
* ударения: à => ǎ, ò => ǒ, ù => ǔ, e => é, ė => ë, i => í, a => á, o => ó, u => ú, y => ý (iy => iý, į => í) (ещё новые буквы: Ǎǎ, Ǒǒ, Ǔǔ, Íí, Éé, Áá, Óó, Úú, Ýý, Ëë).
