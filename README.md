...
Новые буквы: áàóòýỳúùéèìíẁćčśšǧ (18 - ÁÀÓÒÝỲÚÙÉÈÌÍẀĆČŚŠǦ). Ударения: âǎôǒêěûǔî ǐŵŷy̌ãõẽũỹ ĩ ÂǍÔǑÊĚÛǓÎ ǏŴŶY̌ÃÕẼŨỸ Ĩ. То есть, алфавит состоит из 26 букв базовой латиницы и 5 диакритических знаков (акут, гравис, крышка, гачек, тильда). ẁŵ - гласные, то есть над *избранными* согласными ćčśšǧ могут быть только акут и гачек.
...
| щ | sch (shch) |     |     |
| сч | sch (sčh / ssch) |     | вторые варианты нужны только при выходе за словарь известных слов    |
| ссч | ssčh / sssch |     |     |
...
|     |     | *Специальные комбинации, чьё звучание изменяется буквами èìòóàùỳ: b,th,ch,j,g,dj,dg, звучание **b НЕ** меняется буквой Òò.*    | *После b,th,ch,j,g,dj,dg - Óó не смягчает, а полностью меняет звучание предыдущей буквы. Как и после Cc.* |
|     |     |     |     |
|     |     |     |     |
...
|   A    |       O        |    U    |  È (Eh) |  Ỳ (Yh) |
| **Я**  |     **Ё**      |  **Ю**  | **Е**  |  **И**  |
| Á (JA) | EÓ (Eo) / ÉÓ (JEo) |  Ú (JU) | E / É (JE) |  I  |
| **Б**  |     **В**      |  **Г**  | **Д**  |  **Ж**  |
|   B    |       V        | G   |   D    |   Ǧ (Gj)    |
| **З**  |     **Й**      |  **К**  | **Л**  |  **М**  |
|   Z    |     J / JI     |    K    |   L    |    M    |
...
V pjese pro devushcu v zeléonom platjíce vse sadilisé na ladjí I plyli po recè. No tut iz lesa vyshel Gèorgò Maximus, coné v paléto I rvanyh djìnsah, cotoryj cogo-to obìscyval, I pricazal vsem mytésá I gotovité buljon. Znachit snova pjeom do lysyh aqvalangistov.
