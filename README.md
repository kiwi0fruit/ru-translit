...
* [Более этимологический Ь](#%D0%B1%D0%BE%D0%BB%D0%B5%D0%B5-%D1%8D%D1%82%D0%B8%D0%BC%D0%BE%D0%BB%D0%BE%D0%B3%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%8C)
...
* [Альтернативная версия](#%D0%B0%D0%BB%D1%8C%D1%82%D0%B5%D1%80%D0%BD%D0%B0%D1%82%D0%B8%D0%B2%D0%BD%D0%B0%D1%8F-%D0%B2%D0%B5%D1%80%D1%81%D0%B8%D1%8F)
...
* х обозначется **h/ch** (ход/hod, сход/schod).
...
* иногда **w** еще используется как патч для проблем, возникающих из-за словарных исключений - с помощью сброса до дефолтных значений (проект/proekt, проэкт/proektw).
...
* после согласных: sia => sà, siy => sì, sio => sò, siu => sù, (буквы Я,Йи,Ё,Ю), после мягкого знака или й: jja => jà, jje => jè, jji => jì, jjo => jò, jju => jù (и смягчающие, и йотирующие буквы ограниченного применения: Я,Е,Йи,Ё,Ю),
* sye => sê (э),
* wj => ĵ (й), ws => ŝ (для сч),
...
* таким образом, grave (àèìòù) даёт смягчение и йотирование, крышка (êĉĥĵŝ) экранирует от диграфов либо по чтению, либо по обратной трансформации - зависит от контекста, корона и седиль (çšž) меняют звучание, acute (áíéếóúý) и псевдокомбинация grave и acute в виде короны (ǎǐěǒǔ) дают ударение.
...
## Более этимологический Ь

С точки зрения этимологии для Ьь отлично подходит буква Ǝǝ, а для Ъъ - буква Øø. Они визуально хорошо смотрятся в современных текстах - не путаются с Ее и Оо. А в старых будут узнаваться как вариации Ее и Оо, соответственно. Если в современном использовании перед йотированными гласными реализовать проброс смягчения по аналогии с màgkij - pjànyj, то в этих местах мягкий знак и не нужен будет. А в обычных местах останется: konə, Biləbo, pràcəsà.

Это со стороны этимологии. Но вот с точки зрения удобства чтения современного текста лучше pjànyj, konj, Biljbo, pràcjsà.

Так что, возможно, стоит реализовать отдельный режим отображения из дореформенных текстов в латиницу.
...
|    **х**     | **ch** (когда есть неоднозначность из-за других диграфов и триграфов с h), **h** (иначе)                                                                 | сход/schod, кхе/khe, сикх/sikh, шхуна/shchuna, чхать/cchatj, отход/otchod, хахх/hahh, хохолок/hoholok, выход/vyhod, меха/meha, эхо/eho, вече/vece, меча/meca (помимо диграфов из этой спецификации стоит так же избегать **th**)                                         |
...
| ч, c, ch       | чесать/cesatj, Черныш/Cernysh, счётная/sciotnaja/scòtnaja, Кирпичзев/Kirpicjzev/Kirpiĉzev, чхать/cchatj, чьз/cjqqz/ĉjz |
...
Pìony i vasiljci vsò jeşò rastut na polàne vozle derevni Pòny, sçitajuşejsà bogatoj.

Pjànyj master po proectu sdelal mehaniçescij object s izjanom. Jesli brac ne obnarughitsà, to belyje bolidy boljshe ne smogut vyigryvatj gonci.

