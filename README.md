...
Алфавит транслитерации состоит из **25** букв (английский алфавит без Qq). Минималистичная диакритика требует еще три символа (Ęę,Ĵĵ,Şş), итого **28** букв.
...
| э/e    | `^э`&#124;`(?<!\c)э` | `e`   | **эх**о/**eh**o, а**э**роплан/a**e**roplan/a**ę**roplan, **э**тот/**e**tot, **э**он/**e**on, **э**кран/**e**kran, **э**ротика/**e**rotika, й**э**с/j**e**s, Но**э**ль/No**e**lj/No**ę**lj, ало**э**/alo**e**/alo**ę**, радио**э**хо/radio**e**ho (с диакритикой э после гласных всегда должна всегда быть в варианте ę - чтобы убрать необходимость в we) |
| э/ae(ę)   | `(?<=\cа*)э` | `ae`          | м**э**р/m**ae**r/m**ę**r, мер/mer, ма**э**р/ma**ae**r/ma**ę**r, маа**э**р/maa**ae**r, маер/mayer, моаэр/moaer |
| | | | |
