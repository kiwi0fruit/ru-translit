...
3. Немного замечаний о "сч", которые могут быть полезны для обращения латиницы:
...
Часть правил нужно адаптировать из старых версий латиницы: https://vk.com/topic-31851187_48104820
