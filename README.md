...
|       | j/ĵ   | sja/ɉ     | y/yâ/ŷ      | j/sjâ/ȷ     |

Базовый алфавит остоит из 25 букв (английский алфавит без Qq). Плюс 13 букв (Ââ,Ĉĉ,Čč,Êê,Ěě,Ĥĥ,Îî,Ĵĵ,Ôô,Šš,Ûû,Ŷŷ,Žž).  
Расширенный алфавит состоит из 37 букв. Из диакритических знаков для естественных русских языковых конструкций используются только [циркумфлекс](https://ru.wikipedia.org/wiki/%D0%A6%D0%B8%D1%80%D0%BA%D1%83%D0%BC%D1%84%D0%BB%D0%B5%D0%BA%D1%81) и [гачек](https://ru.wikipedia.org/wiki/%D0%93%D0%B0%D1%87%D0%B5%D0%BA). Дополнительно может быть использована редкая модификации j для обозначения ъ в невозмножных позициях (Ɉɉ). Клавиатура Google её не поддерживает.
