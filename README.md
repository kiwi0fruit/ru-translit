...
## Kiwi's Reversible and unambiguous Russian to English transliteration (without use of extra letters, diacritics and non-letter spelling marks). Reversible and unambiguous Romanization of Russian with extended alphabet (Ââ,Ĉĉ,Ėė,Êê,Ĥĥ,Ĵĵ,Ôô,Ṡṡ,Ŝŝ,Ûû,Ŵŵ,Ŷŷ,Ẑẑ)

### Обратимая и однозначная транслитерация из русского в английский алфавит (без использования дополнительных букв, диактрики и небуквенных орфографических знаков). Обратимая и однозначная русская латиница на основе этого транслита с расширенным алфавитом (Ââ,Ĉĉ,Ėė,Êê,Ĥĥ,Ĵĵ,Ôô,Ṡṡ,Ŝŝ,Ûû,Ŵŵ,Ŷŷ,Ẑẑ)
