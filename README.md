...
| Таблица А        | е      |      | ё   |     | йо |      | я  |    | ю  |    |
| ---------------- | ------ | ---- | --- | --- | -- | ---- | -- | -- | -- | -- |
| с большой буквы  | İe     | Ye   | İeo | Yeo | İo | Yo   | İa | Ya | İu | Yu |
| после согласной  | e/ė \* | e/ie | eo  |     | ìô | yiio |    |    |    |    |
| в середине слова |        |      |     |     |    |      |    |    | ìu | iu |
| после Й или И    | è \*\* | ye   | èo  | yeo | ò  | yo   | à  | ya | ù  | yu |
| иначе            | ie     |      | ieo |     | io |      | ia |    | iu |    |

\* ė - точно "мягкая" Е (используется, в том числе, когда нужно обозначить отличие от мягкого знака è),  
\*\* è - так же используется в начале слова в словах исключениях (Èuropa / Европа).

| Таблица Б       | э         |    | о  |    | а  |    | у  |    | ы          |    |
| --------------- | --------- | -- | -- | -- | -- | -- | -- | -- | ---------- | -- |
| после согласной | ê/ae \*   | ae |    |    |    |    |    |    | y/î \*\*\* | y  |
| после И         | ê         | e  | ô  | o  | â  | a  | û  | u  |            |    |
| после Ы         | ê         | ae | ô  | oo | â  | aa | û  | uu |            |    |
| иначе           | e/âe \*\* | e  | o  |    | a  |    | u  |    | hy         |    |

\* ê - так же пишется после согласной + А (maêstro). ae - пишется в словах с этимологией от A (maer),  
\*\* âe - в начале слова в словах с этимологией от A (Âendỳ),  
\*\*\* î - в словах с этимологией от i (latîne).

| Таблица В    | ъе   | ъё    | ъя   | ъю   | ъи | ье   | ьё    | ья   | ью   | ьи   | ьо   |
| ------------ | ---- | ----- | ---- | ---- | -- | ---- | ----- | ---- | ---- | ---- | ---- |
|              | ìê   | ìêo   | ìâ   | ìû   | î  | ìe   | ìeo   | ìa   | ìu   | ìi   | ìo   |
| ASCII версия | yiie | yiieo | yiia | yiiu | y  | iiye | iiyeo | iiya | iiyu | iiyi | iiyo |

| Таблица Г    | ЪЭ  | ЪЫ   | ЪО  | ЪА  | ЪУ  | ЬЭ          | ЬЫ          | ЬА          | ЬУ          |
| ------------ | --  | ---- | --- | --- | --- | ----------- | ----------- | ----------- | ----------- |
...
|                                | й                 |     | ъ                 |      | ь                 |         |
| ------------------------------ | ----------------- | --- | ----------------- | ---- | ----------------- | ------- |
| (звучащие) как в Табл. А,В,Г   | как в Табл. А,В,Г |     | как в Табл. А,В,Г |      | как в Табл. А,В,Г |         |
| перед согласной в начале слова | ì                 | ii  | None              |      | None              |         |
| после ШЩЧЖ                     | òì                | -ii | ò                 | None | è                 | None    |
| между согласными               | òì                | -ii | ò                 | -    | è/ì \*            | ii      |
| после согласной в конце слова  | òì                | -ii | ò                 | None | è/e \*\*          | ii/e    |
| иначе                          | i                 |     | -                 |      | -                 |         |    

\* ì - пишется в заимствованиях с этимологией, в которой è неуместна в корне или даже в основе (culìtura),  
\*\* e - в случае аналога открытого слога (гласная + однобуквенная-согласная + e) e на конце считается мягким знаком è. Для того, чтобы написать аналогичное Е (йэ) нужно использовать ė или ê: cone, o conė. Не распространяется на kè, gè (который "ж" в заимствованиях, ge - ге, ghè - гь), jè (жь) и все модиф. диакритикой согласные (см. след раздел).
