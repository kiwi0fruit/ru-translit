...
|                                                                                   |              Cyrillic RegEx | Translit RegEx       | Latiniça RegEx       | Примеры                                                                                                                                                 |
| --------------------------------------------------------------------------------- | ---------------------------:|:-------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ъ[еёюя]/j[eoua] (после согласных перед йотированными гласными)                    |            `(?<=\c)ъ[еёюя]` | `(?<=\c)j[eoua]`     |                      | объект/objekt/object, изъян/izjan                                                                                                                              |
| ъ/wj/j                                                                            |               `ъ(?=[\w\c])` | `wj`                 | `j`                  | онъ/onwj/onj, Муъминат/Muwjminat/Mujminat                                                                                                              |
| ъ/wjh/ĵ                                                                           |                         `ъ` | `wjh`                | `ĵ`                  | объизвестить/obwjhizvestitj/obĵizvestitį, Йонъин/Jonwjhin/Jonĵin, Чанъань/Chanwjhanj/Chanĵanį (не йотированные)                                         |
| ъи/ji  (исключения отображения)                                                   |                   `объимат` | `objimat`            |                      | объимать/objimatj/objimatį (йотированные)                                                                                                               |
|                                                                                   |                             |                      |                      |                                                                                                                                                         |
| ь[еёюяи]/jy[eouai]/įy[eouai] (после согласных перед и или йотированными гласными) |           `(?<=\c)ь[еёюяи]` | `(?<=\c)jy[eouai]`   | `(?<=\c)įy[eouai]`   | пьеса/pjyesa/pjyesa, пьян/pjyan/pįyan, ладьи/ladjyi/ladįyi, платьице/platjyice/platįyice                                                                |
| ьо/jyio  (после согласных перед о)                                                |                 `(?<=\c)ьо` | `(?<=\c)jyio`        | `(?<=\c)įjo`         | батальон/bataljyion/batalįjon, лосьон/losjyion/losįjon, сеньор/senjyior/senįjor                                                                         |
| ь/j  (после согласных перед согласными или в конце слова)                         |        `(?<=\c)ь(?=[\w\c])` | `(?<=\c)j(?=[\w\c])` | `(?<=\c)į(?=[\w\c])` | прячься/pryachjsya/pryachįsya, мыться/mytjsya/mytjsya, конь/konj/konj                                                                                   |
