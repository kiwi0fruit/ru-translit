...
* Ꞌꞌ вместо Ww, а так же вместо k перед h. Это [Saltillo](https://en.wikipedia.org/wiki/Saltillo_(linguistics))) - полноценная некомбинируемая буква, имеющая верхний и нижний регистры. Это меняет переключатель w из йод/yodꞌ, сход/sꞌhod, сэр/sꞌer, выучить/vyꞌuchitį, выискивать/vyꞌiskivatį.
* śh вместо sjh (Щ),
* dž вместо dzh (ДЖ),
