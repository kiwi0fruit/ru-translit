...
* таким образом, grave (àèìòù) даёт смягчение и йотирование, крышка (ĉêĥĵŝ) экранирует от диграфов, корона и cедиль (çšž) меняют звучание, acute (áíéếóúý) и псевдокомбинация grave и acute в виде короны (ǎǐěǒǔ) дают ударение.
...
|    sc  | None/qq | j/jqq | sc/ŝc  | ĉz, cjqqz, cž, dž, žž   |
