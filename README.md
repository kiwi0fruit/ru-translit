...
* Įį вместо Jj,
* Ꞌꞌ вместо Ww, а так же вместо k перед h. Это [Saltillo](https://en.wikipedia.org/wiki/Saltillo_(linguistics)) - полноценная некомбинируемая буква, имеющая верхний и нижний регистры (йод/yodꞌ, сход/sꞌhod, сэр/sꞌer, выучить/vyꞌuchitį, выискивать/vyꞌiskivatį).
* śh вместо sjh (Щ),
* dž вместо dzh (ДЖ),
...
*Всё остальное тоже самое, что и в предыдущем варианте.* Новые буквы, встречающиеся не в аббревиатурах: Śś(Щ), Įį(Ь, смягчение), DŽdž(ДЖ), Ꞌꞌ(буква для частых диграфов), Ŷŷ(очень редкое Й).
...
|:------------:|:----------------------------------------------------------------------------------------------------------------- |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|    **ъи**    | **yi** (**ъи** после согласных в словарных словах-исключениях, когда и йотируется)                                | объимать/obyimatj, обйимать/obyimatjw/obyimatįꞌ, обйимоть/obyimotį, объимоть/obqqimotj/obqqimotį, объйимать/obqqyimatj/obqqyimatį (здесь логика модификации с помощью w(h) изменена только для словарных слов-исключений)                                           |
|    **ъ**     | None (после согласных перед **яёюе**), **qq** (иначе)                                                     | изъян/izyan, объект/obyekt, объизвестить/obqqizvestitj/obqqizvestitį, Йонъин/Yonqqinw/Yonqqinꞌ, Сёркйосен/Sjorkyosenw/Sįorkyosenꞌ, онъ/onqq, Муъминат/Muqqminat, Чанъань/Chanqqanj/Chanqqanį, нъын/nqqwyn/nqqꞌyn                                        |
|    **ьо**    | **jyo...w** / **jyo...ꞌ** (**jyoh** / **jŷo**) (**ьо** когда они **йотируются**, а это почти всегда)                                          | бульон/buljyonw/bulįyonꞌ, бульонъён/buljyohnyon/bulįŷonyon, сеньор/senjyorw/senįyorꞌ, лосьон/losjyonw/losįyonꞌ, лосьйон/losjyonww/losįyonꞌꞌ (здесь **специально для ьо** изменена логика модификации с помощью w(h))                                                                                   |
|    **ьи**    | **jyi** (**ьи** когда они **йотируются**, а это почти всегда)                                                     | ладьи/ladjyi/ladįyi, платьице/platjyice/platįyice, ладьйи/ladjyiw/ladįyiꞌ (здесь **специально для ьи** изменена логика модификации с помощью w(h))                                                                                                                                 |
|  **ь[ауэ]**  | **jy[aue]...w** / **jy[aue]...ꞌ** (**jy[aue]h** / **jŷ[aue]**) (гласные **ауэ** после **ь** в словарных словах-исключениях, когда они **йотируются**) | бельэтаж/beljyetazhw/belįyetazhꞌ, бельйэтаж/beljyetazhww/belįyetazhꞌꞌ, бельэт/beljqqet/belįqqet (здесь логика модификации с помощью w(h) изменена только для словарных слов-исключений)                                                                             |
|    **ь**     | **jqq** / **įqq** (перед гласными **аоуэиы** когда они **не** йотируются), **j** / **į** (иначе)                           | грабьармия/grabjqqarmiya/grabįqqarmiya, костьутиль/kostjqqutilj/kostįqqutilį, пьеса/pjyesa/pįyesa, пьян/pjyan/pįyan, прячься/prjachjsja/prįachįsįa, мыться/mytjsja/mytįsįa, конь/konj/konį, ньын/njqqwyn/nįqqꞌyn                                                                                       |
...
| **ы[аоуэи]** | **yw[aouei]** / **yꞌ[aouei]** (гласные **аоуэи** после ы)                                                          | выход/vyhod, выигрывать/vywigryvatj/vyꞌigryvatį, выучить/vywuchitj/vyꞌuchitį, выострить/vywostritj/vyꞌostritį                                                                                                                                                   |
...
|  **[яёю]**   | **j[aou]** / **į[aou]** (после согласных), **y[aou]** (иначе)                                                                  | мёд/mjod/mįod, ёлка/yolka, пюре/pjure/pįure, якорь/yakorj/yakorį                                                                                                                                                                                                                |
|    **х**     | **kh** / **ꞌh** (когда есть неоднозначность из-за других диграфов и триграфов с h), **h** (иначе)                          | сход/skhod/sꞌhod, кхе/kkhe/kꞌhe, сикх/sikkh/sikꞌh, шхуна/shkhuna/shꞌhuna, чхать/chkhatj/chꞌhatį, отход/otkhod/otꞌhod, хахх/hahh, хохолок/hoholok, выход/vyhod, меха/meha, эхо/eho, вече/veche, меча/mecha, сьха/sjkha/sįꞌha, ньхи/njhi/nįhi         |
...
|          | Ещё примеры                         |
| -------- | ----------------------------------- |
| щ/sjh(śh) | щётка/sjhjotka/śhįotka, счёт/schjot/schįot |
...
Алфавит транслитерации использует все буквы английского алфавита кроме Xx. Алфавит латиницы не использует Ww, Xx, Jj и дополнительно использует 13 новых букв (см. ниже).
...
Основная раскладка. Добавляет новые буквы, встречающиеся более менее часто: Įį(Ь), Śś(Щ), Žž(Ж), Ꞌꞌ(буква для диграфов).
...
Дополнительная раскладка. Буквы для аббревиатур и очень редких слов: Ââ(Я),Êê(Е),Ôô(Ё),Ûû(Ю),Čč(Ч),Šš(Ш),Žž(Ж),Ĥĥ(Х),Ŷŷ(Йй).

| :;  |   1!   |   2"   |   3'   |   4$   | 5%  |   6^   |   7&   | 8\* |   9(   | 0)  | -\_ |  =+  |
|:---:|:------:|:------:|:------:|:------:|:---:|:------:|:------:|:---:|:------:|:---:|:---:|:----:|
|     |   Qq   | **Ꞌꞌ** | **Êê** |   Rr   | Tt  | **Ŷŷ** | **Ûû** | Ii  | **Ôô** | Pp  | Śś  |  Žž  |
...
Pįyanyy master po proektu sdelal mehanicheskiy obyekt s izyanom. Yesli brak ne obnaruzhitsįa, to belyye bolidy bolįshe ne smogut vyꞌigryvatį gonki.

V pįyese pro devushku v zelįonom platįyice vse sadilisį na ladįyi i plyli po reke. No tut iz lesa vyshel Džordž Maksimus, konį v palįto i rvanyh džinsah, kotoryy chto-to vyꞌiskival, i prikazal vsem mytįsįa i gotovitį bulįyonꞌ. Znachit snova pįyom do lysyh akvalangistov.

Prepodobnyy Bayyes podkinul igralįnyye kosti. Vypalo shestį, znachit yemu pridįotsįa mazatį yodꞌ na ranu.

Mꞌer nebolįshogo gorodishki otkryl tablicu ekselįa i vozmutilsįa cenoy novogo ekskavatora. Azh ekzema snova stala yego bespokoitį. Oh uzh eta pokupka vechnogo dvigatelįa v proshlom godu! A tak zhe pokupka aeroplana-ekranolįota. Yesli tak poydįot i dalįshe, to bįudzhetu pridįotsįa hudo.
...
Imeyetsįa neskolįko gipotez proisꞌhozhdeniya sobaki, naiboleye veroyatnymi yeyo predkami schitayutsįa volk i nekotoryye vidy shakalov.

V suzhdeniyah uchįonyh o predkah domashney sobaki prisutstvuyut dve tochki zreniya. Odni schitayut, chto sobaki - polifileticheskaya gruppa (proisꞌhodįaśhaya ot neskolįkih predkov), drugiye priderzhivayutsįa mneniya, chto vse sobaki proizoshli ot odnogo predka (monofileticheskaya teoriya).
