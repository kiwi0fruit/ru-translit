...
* Порядок выбора для йотации гласных е,ё,ю,я,ьо,ьэ,ьи,ъи: **į, y, j**. Если один вариант может значить другое, то берется следущий.
* Порядок выбора смягчения согласных: **į, î**.
* Порядок выбора обозначения й: **y, į, j, ŷ**.
* Йотированная остановка: **j**.
* Не йотированная остановка: **ĵ**.
* Порядок выбора обозначения ы: **y, ȳ**.
