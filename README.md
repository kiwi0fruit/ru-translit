...
| е/ye         |                   `^е`&#124;`(?<!\c)е` | `ye`                      | если/yesli/įesli, байес/bajyes/bajįes, Раевская/Rayevskaya/Raįevscaįa, зяе/zyaye/zįaįe, заем/zayem/zaįem, заём/zayom/zaįom, ехо/yeho/įeho, йeс/jyes/jįes, таец/tayec/taįeç, заезд/zayezd/zaįezd, траектория/trayektoriya/teaįectoriįa |
| е/e          |                                    `е` | `e`                       | м**е**х/m**e**h                                                                                                                                                                                                                     |
