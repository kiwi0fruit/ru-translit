...
|   **щ**   |  **ъ**  |   **ь**   | **кс, кц, ктс** | **сч, саэ** |
| sc/scí/sč | None/ø̂ |   í/íø̂   |  cs, cts, ckts  | sc/ŝc, saae  |
...
В ASCII-латинице-26 используется 25 букв - все, кроме Xx. В финальной юникод-латинице используются 23 буквы базовой латиницы (все кроме Xx, Qq, Ww), плюс ещё 7 букв основного алфавита Éé, Ææ, Øø, Ǿǿ, Ø̂ø̂, Íí, Çç и 5 букв алфавита обеспечения обратимости в кириллицу и обратно: Ŝŝ, Ĵĵ, Ťť, Čč, Ğğ. Итого: 30 + 5 буквы.
