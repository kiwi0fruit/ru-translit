...
Неиспользуемые стандартные буквы: Ww. Буквы для аббревиатур: Ââ(Я),Êê(Е),Ôô(Ё),Ûû(Ю),Čč(Ч),Šš(Ш),Žž(Ж),Ĥĥ(Х),Ŷŷ(Й),Ŝŝ(Щ),Ěě(Э). Для очень редких слов: HYhy(Ы),JQQjqq(Ь),QQqq(Ъ). Примечательные стандартные: Jj(ДЖдж,Ь),Xx(КСкс).
...
Новые более-менее частые буквы: Ęę(Э), Şş(Щ), Įį(Ь). Неиспользуемые старые: Ww, Qq. Буквы для аббревиатур: Ââ(Я),Êê(Е),Ôô(Ё),Ûû(Ю),Čč(Ч),Šš(Ш),Žž(Ж),Ĥĥ(Х),Ŷŷ(Й). Для очень редких слов: ??(Ы),Îî(Ь),??(Ъ). Примечательные старые: Jj(ДЖдж),Xx(КСкс).
