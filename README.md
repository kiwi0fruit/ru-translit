...
|    **ь**     | **jqq** / **î** (перед гласными **аоуэ** или **ои** когда они **не** йотируются), **j** / **į**(иначе)                                                             | грабьармия/grabjqqarmiya/grabîarmiya, пьеса/pjyesa/pįyesa, ладьи/ladjyi/ladįyi, грабьобоз/grabjqqoboz/grabîoboz (выдуманное слово) |
...
Для обратимых аббревиатур, выглядящих прилично и совместимых с чтением по-русски придётся расширять алфавит. Буквы, уже используемые в латинице, помечены курсивом. Остальные - используются только в аббревиатурах:
...
Примеры аббревиатур: ГЭС/GĘS, АЭС/AES, ЖКХ/ŽKĤ, ЖЭК/ŽĘK, ЕС/ĖS, США/SŠA, МЧС/MĈS, ЮАР/ÜAR, ЭЭГ/EEG, ЕГ/ĖG, микрорайон Щ/mikrorayohn Ŝ.
...
|          | Aa  |   Ss   |   Dd   |   Ff   | Gg    | Hh     | Jj     | Kk  | Ll  | **Įį**(;:ж) | **Ęę**('"э) | **Ïï**(\\\|/) |
...
|    | **Ää** | **Šš** |   Dd   |   Ff   | Gg     | **Ĥĥ** | Jj     | Kk     | Ll     | Įį | Ęę  | Ïï  |
