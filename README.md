...
*Всё остальное тоже самое, что и в предыдущем варианте.* Новые буквы, встречающиеся не в аббревиатурах: Įį(Ь), Ŝŝ(Щ), Žž(Ж), Ęę(Э), Ïï(И), Ÿÿ(Ы), Ŷŷ(Й). Совсем редкие буквы теперь: **ь**: Îî, **ъ**: QQqq.
