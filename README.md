...
* [Английская латиница 25](#%D0%B0%D0%BD%D0%B3%D0%BB%D0%B8%D0%B9%D1%81%D0%BA%D0%B0%D1%8F-%D0%BB%D0%B0%D1%82%D0%B8%D0%BD%D0%B8%D1%86%D0%B0-25)
...
* "gh" для неправильного "г" в окончаниях (его/jegho).
...
* после согласных sia => sà, sio => sò, siu => sù (я,ё,ю), мягкий знак sjqq => sì, sj => sì, qjqq => ì (смягчающие, но не йотирующие буквы),
* siy => sį (и),
* sye => sė (э),
* wj => ĵ (й),
* wsc => ŝc (сч),
...
* dzh => dž (дж),
* cz => ç (ц),
* добавлены новые буквы Àà, Òò, Ùù, Ìì, Įį, Ęę, Çç, Ŝŝ, Ĵĵ, Žž, Ɂɂ, и убраны Xx, Ww, Qq,
* отличия аббревиатур описаны отдельно (ещё новые буквы: Èè, Šš, Ĥĥ),
* ударения: sà => sǎ, sò => sǒ, sù => sǔ, se => ě (je => jé), sę => sé, i => í, a => á, o => ó, u => ú, y => ý (iy => iý, į => í) (ещё новые буквы: Ǎǎ, Ǒǒ, Ǔǔ, Ěě, Íí, Éé, Áá, Óó, Úú, Ýý).
