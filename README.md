...
Новые буквы: áàóòýỳúùéèìíẁçćčśšǧ (19 - ÁÀÓÒÝỲÚÙÉÈÌÍẀÇĆČŚŠǦ). Ударения: âǎôǒêěûǔî ǐŵĵŷy̌ãõẽũỹ ĩ ÂǍÔǑÊĚÛǓÎ ǏŴĴŶY̌ÃÕẼŨỸ Ĩ. То есть, алфавит состоит из 26 букв базовой латиницы и 5 диакритических знаков (акут, гравис, крышка, гачек, тильда). 
...
*(Специальные комбинации, чьё звучание изменяется буквами èìòóàùỳ: b,th,ch,j,dj,g,dg, звучание **b НЕ** меняется буквой ò, **только у ch** может вклиниваться согласная),*  
