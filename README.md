...
|        | Cyrillic RegEx | Latin RegEx   | Примеры                                                                            |
| ------ | --------------:|:------------- | ---------------------------------------------------------------------------------- |
| туер/буер/конгруен/проект/.../we | `туер`&#124;`буер`&#124;`конгруен`&#124;`проект`&#124;`...` | `we` | туерный/tuwernyj, туер/tuwer, буер/buwer, проект/prowekt (слова, которые должны были быть с `ye`, но произносятся с "э") |
