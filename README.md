...
| й/jj/ĵ | `(?<=ы)й(?=[эоуае])` | `jj` | белы**й**а/bely**jj**a/bely**ĵ**a, белы**й**е/bely**jj**e/bely**ĵ**e, **й**эс/**jj**es/**ĵ**es |
...
|        | Cyrillic RegEx | Latin RegEx   | Примеры                                                                            |
| ------ | --------------:|:------------- | ---------------------------------------------------------------------------------- |
| е/ye/ê |     `(?<!\c)е` | `ye`          | за**е**зд/za**ye**zd/za**ê**zd, бай**е**с/baj**ye**s/baj**ê**s, **е**сли/**ye**sli |
