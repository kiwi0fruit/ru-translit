...
* после согласных sia => sà, sio => sò, siu => sù (я,ё,ю), мягкий знак sjja => sjà, sjjo => sjò, sjju => sjù, sjje => sjè (смягчающие, но не йотирующие буквы),
* siy => sì (и),
* sye => sė (э),
* wj => ĵ (й),
* wsc => sĉ (сч),
...
* cz => ç (ц),
* добавлены новые буквы Àà, Òò, Ùù, Èè, Ìì, Ėė, Çç, Ĉĉ, Ĵĵ, Žž, ' (апостроф в конце слова) и убраны Xx, Ww, Qq,
* отличия аббревиатур описаны отдельно (ещё новые буквы: Šš, Ĥĥ),
...
|:------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------- |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|    **ъ**     | None (после согласных перед **яёюе**), **qq** (иначе)                                                                                                    | изъян/izjan, объект/objekt, объимать/obqqimatj/obꞌimatì, объизвестить/obqqizvestitj/obꞌizvestitì, Йонъин/Jonqqin/Jonꞌin, Сёркйосен/Siorkjosen, ёркйосен/jorkwjosen/jorkĵosen, онъ/onqq/onqq, Муъминат/Muqqminat/Muꞌminat, Чанъань/Canqqanj/Canꞌanì, нъын/nqqyn/nꞌyn                                             |
|    **ьо**    | **jjo/jò**                                                  | бульон/buljjon/bulìjon, бульонъён/buljwjonjon/bulìĵonjon, сеньор/senjjor/senìjor, лосьон/losjjon/losìjon, лосьён/losjqqjon/losìꞌjon, лосьйон/losjwjon/losìĵon, осьён/osjjon/osìjon, осьон/osjwjon/osìĵon, осьйон/osjqqwjon/osìꞌĵon (здесь **специально для словарных слов с ьо** изменена логика модификации с помощью w - важно какой вариант, ьё или ьо, является ходовым для данного слова)                  |
|    **ьи**    | **jji/jì**                                                                                            | ладьи/ladjji/ladìji, платьице/platjjicze/platìjiçe, Вильйинг/Viljqqjing/Vilìꞌjing                                                                                                      |
