...
Частые новые буквы: Çç(Ц), Ęę(Э), Şş(Щ), Įį(йот). Неиспользуемые старые: Ww, Qq. Буквы для аббревиатур: Â(Я),Ê(Е),Ô(Ё),Û(Ю),Ĉ(Ч),Ĥ(Х),Ŝ(Ш),Ŷ(Ы), ?(Й). Старые примечательные: J(Ж).
