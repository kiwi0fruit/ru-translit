...
|              | Правило транслита / правило латиницы                                                                                                                               | Пример транслита / пример латиницы                                                                |
|:------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------ |:------------------------------------------------------------------------------------------------- |
|    **ъ**     | None (после согласных перед **яёюе** или **и** когда она йотируется), **qq** (иначе)                                                                               | изъян/izyan, объимать/obyimatj/obyimatį, объизвестить/obqqizvestitj/obqqizvestitį, Йонъин/Jonqqin |
| **ь[аоуэ]**  | **jy[aoue]h** / **įy[aoue]h** (гласные **аоуэ** после **ь** когда они **йотируются**: о йотируется почти всегда, ауэ почти не йотируются за редкими исключениями)  | бульон/buljyohn/bulįyohn, бельэтаж/beljyehtazh/belįyehtazh                                        |
|    **ь**     | **jqq** / **î** (перед гласными **аоуэи** когда они **не** йотируются), **j** / **į**(иначе)                                                                       | грабьармия/grabjqqarmiya/grabîarmiya, пьеса/pjyesa/pįyesa, ладьи/ladjyi/ladįyi                    |
| **й[аоуэ]**  | **y[aoue]h** / **ŷ[aoue]** (гласные **аоуэ** после й)                                                                                                              | йод/yohd/ŷod                                                                                      |
|    **й**     | **y** (остальные случаи)                                                                                                                                           | красный/krasnyy, аллилуйя/alliluyya                                                               |
|    **ы**     | **y** (после согласных), **hy** / **ÿ** (иначе)                                                                                                                    | пыл/pyl, Нарва-Йыэсуу/Narva-Yhyhesuu/Narva-Yÿesuu                                                 |
| **ы[аоуэи]** | **yh[aouei]** / **ÿ[aouei]** (гласные **аоуэи** после ы)                                                                                                           | выход/vykhod/vÿhod, выигрывать/vyhigryvatj/vÿigryvatį, выучить/vyhuchitj/vÿuchitį                 |
|    **е**     | **е** (после согласных или в ситуациях когда е читается как э), **ye** (иначе)                                                                                     | мера/mera, еда/yeda, проект/proekt                                                                |
|    **э**     | **ae** / **ę** (после согласных), **е** (иначе)                                                                                                                    | мэр/maer/męr, этот/etot                                                                           |
...
|    **х**     | **kh** (когда есть неоднозначность из-за других диграфов и триграфов с h), **h** (иначе)                                                                           | сход/skhod, лях/liakh/lįah                                                                        |
|    **дж**    | в словах, где **д** и **ж** не попадают в разные морфемы и нет чередования корней, где они порознь: **j** (перед гласными **аоуэи**), **jh** (в остальных случаях) | Джордж/Jorjh, поджечь/podzhechj/podzhechį                                                         |
|    **кс**    | в словах, где **к** и **с** не попадают в разные морфемы и нет чередования корней, где они порознь: **x**                                                          | Максим/Maxim, спёкся/spioksia/spįoksįa                                                            |

Из таблицы видно, что для ь и ъ (особенно ъи и ьэ) придется определять отображение по умолчанию и запомненные в словарь исключения из него. Так, стоит ожидать, что ъи и ьэ по умолчанию должны быть не йотированными, но известны и йотированные исключения.
...
| **ч** | **щ** | **ж** | **ш** | **х** | **й** | **ь** |
|  Ĉĉ   | [Ŝŝ]  |  Žž   |  Šš   |  Ĥĥ   | [Ŷŷ]  | [Îî]  |

**ъ**: QQqq.

Для совместимости с кириллицей в аббревиатуры J идёт как D, а X идёт как K.

Примеры аббревиатур: ГЭС/GĘS, АЭС/AES, ЖКХ/ŽKĤ, ЖЭК/ŽĘK, ЕС/ĖS, США/SŠA, МЧС/MĈS, ЮАР/ÜAR, ЭЭГ/EEG, ЕГЭ/ĖGĘ, микрорайон Щ/mikrorayohn Ŝ.
...
Дополнительная раскладка. Буквы для аббревиатур: Ää(Я),Ėė(Е),Öö(Ё),Üü(Ю),Ĉĉ(Ч),Šš(Ш),Žž(Ж),Ĥĥ(Х). Для очень редких слов: Îî(Ь).

| Ÿÿ  |   1!   |   2"   |   3'   |   4;   | 5%  |   6:   |   7?   |  8\*   |   9(   | 0)  | -\_ | =^  |
|:---:|:------:|:------:|:------:|:------:|:---:|:------:|:------:|:------:|:------:|:---:|:---:|:---:|
|     |   Qq   |   Ww   | **Ėė** |   Rr   | Tt  | **Ÿÿ** | **Üü** | **Îî** | **Öö** | Pp  | Ŷŷ  | Ŝŝ  |
|     | **Ää** | **Šš** |   Dd   |   Ff   | Gg  | **Ĥĥ** |   Jj   |   Kk   |   Ll   | Įį  | Ęę  | \\/ |
|     |        | **Žž** |   Xx   | **Ĉĉ** | Vv  |   Bb   |   Nn   |   Mm   |   ,<   | .>  | Ïï  |     |
