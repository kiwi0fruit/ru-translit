...
| ъ/wjh/ĵ                                                                           |                         `ъ` | `wjh`                | `ĵ`                  | объизвестить/obwjhizvestitj/obĵizvestitį, Йонъин/Jonwjhin/Yonĵin, Чанъань/Chanwjhanj/Chanĵanį (не йотированные)                                         |
| ъи/ji  (исключения отображения)                                                   |                   `объимат` | `objimat`            |                      | объимать/objimatj/objimatį (йотированные)                                                                                                               |
|                                                                                   |                             |                      |                      |                                                                                                                                                         |
| ь[еёюяи]/jy[eouai]/įy[eouai] (после согласных перед и или йотированными гласными) |           `(?<=\c)ь[еёюяи]` | `(?<=\c)jy[eouai]`   | `(?<=\c)įy[eouai]`   | пьеса/pjyesa/pįyesa, пьян/pjyan/pįyan, ладьи/ladjyi/ladįyi, платьице/platjyice/platįyiçe                                                                |
...
| ь/j  (после согласных перед согласными или в конце слова)                         |        `(?<=\c)ь(?=[\w\c])` | `(?<=\c)j(?=[\w\c])` | `(?<=\c)į(?=[\w\c])` | прячься/pryachjsya/prįachįsįa, мыться/mytjsya/mytįsįa, конь/konj/konį                                                                                   |
