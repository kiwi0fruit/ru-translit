...
* Убрать смягчение после согласной можно с помощью **ye** (мэр/myer, сэр/syer). sya и sa значат одно и то же (как и syu/su, syo/so), но первый вариант не используется за избыточностью. **yy** используется аналогично случаю с "и" перед не йотированными гласными (сыо/syyo).
