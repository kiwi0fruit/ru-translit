...
| **Ф** |     **Х**      |  **Ц**  | **Ч**  |  **Ш**  |
|   F   |       Ch       |    Ct   | Cj(C')/Cí |   Sh    |
| **Щ** | **КЦ, КИ, ЧИ, ЙА, ЯР, ФИО, ТИТ** | **КТС** | **СЧ**  | **САЭ, СЭ, СЕ** |
|  Sc   | CCt, CIY, CjIY(C'IY)/CíIY, JA, IAR, FIYO, TIT |   CTS   | SCj/SCí | SAE, SE, SIE |

Внутри аббревиатур (но не в конце) диграфы Cj, Gj могут быть заменены на C', G'. IY вместо I применяется перед гласными либо когда послее нее больше нет заглавных букв (формализация ситуации путаницы с Ll, например, Cl это хлор в Таблице Менделеева, но КИ/CI тоже мог бы так выглядеть).
