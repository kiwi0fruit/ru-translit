...
|    sc     | None / ꞌ / qq | ì / ìꞌ | sc / ŝc | chz, cž, dž, žž |
...
|:------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------- |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|    **ъ**     | None (после согласных перед **яёюе**), **qq/ꞌ** (иначе, не в конце слова), **qq** (в конце слова)                                                                                                    | изъян/izjan, объект/objekt, объимать/obqqimatj, объизвестить/obqqizvestitj, Йонъин/Jonqqin, Сёркйосен/Siorkjosen, ёркйосен/jorkwjosen, онъ/onqq, Муъминат/Muqqminat, Чанъань/Canqqanj, нъын/nqqyn/nqqyn                                             |
...
|    **э**     | **ye/ę** (после согласных или после ы в закрытом слоге), **е** (иначе)                                                                                                         | мэр/myer, этот/etot, аэроплан/aeroplan, поэт/poet, эротика/erotika, йэс/wjes, ыэр/yer, мыэр/myyer                                                                                                                                               |
