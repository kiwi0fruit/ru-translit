...
* Пауза и йотация следующей гласной (гласная должна быть): **j**.
* Пауза без йотации: **ĵ**.
* После согласных е всегда **e**.
* Если один вариант может значить другое, то берется следущий.
  * Порядок выбора обозначения э: **e**.
  * Порядок выбора для йотации гласных е,ё,ю,я,ьо,ьэ,ьи,ъи: **į, y, j**. 
  * Порядок выбора смягчения согласных: **į**.
  * Порядок выбора обозначения й: **y, į, j**.
  * Порядок выбора обозначения ы: **y**.
* Если собрать сочетание не получается (есть двусмысленность), то использовать:
  * э - **ę**,
  * ь - **î**,
  * й - **ŷ**,
  * ы - **ȳ**,
* Использовать эти три буквы с начала места неоднозначности. Заменить первую и попробовать сделать однозначно остальное без использования этих трёх замен. Получилось - отлично. Не получилось - заменить следующую букву.
* При обратном восстановлении используется порядок важности букв (как тут). Буква без диакритики считается той, что более важная. Если прообраз от образа слова не равен слову, то нужно использовать следующую комбинацию. ~Йотации гласных всегда имеют приоритет в восстановлении~.
* Не должно быть повторов букв в латинице если в кириллице их не было. Одна буква с разной диакритикой это тоже плохо (такое можно только при отсутствии других вариантов). Įį считается как отдельная буква, а диакритика для нее это Îî.
...
| ъ/ĵ                  |                   `ъ` | `ĵ`          | *(не йотированные)* объизвестить/obĵizvestitį, Йонъин/Yonĵin, Чанъань/Chanĵanį, онъ/onĵ, Муъминат/Muĵminat, Муръйин/Murĵyin, Чанъын/Сhanĵȳn |
|                      |                       |              |                                                                                                                                             |
...
| ь/î                  |                   `ь` | `î`          | *(не йотированные, просто смягченные)* костьутиль/costîutilį, грабьармия/grabîarmiįa, Мурьйин/Murîyin, Чаньын/Сhanįȳn                       |
|                      |                       |              |                                                                                                                                             |
| ый/yj                | `(?<=\c)ый(?![\w\c])` | `yj`         | *(после согласной, но НЕ перед согласной или конца слова)* белыйа/belyja, белыйя/belyįya?/belyjįa?                                                                                                               |
| ы/y                  |            `(?<=\c)ы` | `y`          | *(после согласных)* белые/belyįe, белый/belyį                                                                                |
| ы/ȳ                  |            `(?<!\c)ы` | `ȳ`          | *(не после согласных)* ынлу/ȳnlu, ыы/ȳȳ, Нарва-Йыэсуу/Narva-Įȳesuu                                                                                                                                       |
|                      |                       |              |                                                                                                                                             |
| ый/yį                | `(?<=\c)ый(?=[\w\c])` | `yį`         | *(перед согласными и в конце слова)* белый/belyį, белыйс/belyįs                                                                             |
| ы/ŷ                  |         `ы(?=[эоуа])` | `yw`         | Нарва-Йыэсуу/Narva-Įȳesuu, Баймаклыаул/Baymaklȳaul, белыйа/belyŷa, белыйя/belyŷįa                                                           |
| ыи/ŷi                |        `(?<![й\c])ыи` | `ywi`        | аыи/aŷi, сьыио/sjywio                                                                                                                  |
| ыи/yi                |        `(?<=[й\c])ыи` | `yi`         | выигрывать/vyigryvatj, выискивать/vyiskivatj                                                                                                |
| ы/y                  |                   `ы` | `y`          | крыска/kryska, ыпся/ypsja, пыхтел/pyhtel, выйигрывать/vyjigryvatj, байыс/bajys                                                 |
|                      |                       |              |                                                                                                                                             |
| й/ŷ                  |            `(?<=\c)й` | `ŷ`          | Сёркйосен/Sįorkŷosen                                                                                                                        |
| йы/įȳ                |            `(?<!ы)йы` | `įȳ`         | Нарва-Йыэсуу/Narva-Įȳesuu                                                                                                                   |
| й/jj                 |   `(?<=ы)й(?=[эоуа])` | `jj`         | аллилуйя/alliluyįa, белыйа/belyjja, белыйэ/belyjje, белыйе/belyjye                                                                                              |
| й/j                  |                   `й` | `j`          | байес/bajyes, йод/jod, йиппи/jippi, байяс/bajyas, байас/bajas, йэс/jes, баян/bayan                                             |
