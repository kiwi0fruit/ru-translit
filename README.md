...
|        | Cyrillic RegEx | Latin RegEx   | Примеры                                                                            |
| ------ | --------------:|:------------- | ---------------------------------------------------------------------------------- |
| туер/буер/конгруен/проект/.../we | `туер`&#124;`буер`&#124;`конгруен`&#124;`проект`&#124;`...` | `we` | ту**е**рный/tu**we**rnyj, ту**е**р/tu**we**r, бу**е**р/bu**we**r, про**е**кт/pro**we**kt (слова, которые должны были быть с `ye`, но произносятся с "э") |
| е/ye   | `^е`&#124;`(?<!\c)е` | `ye` | **е**сли/**ye**sli, бай**е**с/baj**ye**s, Ра**е**вская/Ra**ye**vskaya, зя**е**/zja**ye**, за**е**м/za**ye**m, заём/zayom, **е**хо/**ye**ho, йeс/j**ye**s, та**е**ц/ta**ye**c, за**е**зд/za**ye**zd |
| е/e    | `е`            | `e`           | м**е**х/m**e**h |
...
| э/ae   | `э`            | `ae`          | м**э**р/m**ae**r, мер/mer, ма**э**р/ma**ae**r, в**эч**ный/v**aech**nyj |
| | | | |
