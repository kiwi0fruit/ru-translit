...
|                      |                             |                |                                                                                                                                                         |     |
| проект/.../e         |         `проект`&#124;`...` | `e`            | *(исключения отображения)* проект/proekt, проэкт/proękt (слова, которые должны были быть с йотированной е, но произносятся с ударным звуком э)             |     |
...
| e/e                  | не йотированные исключения отображения               | проект/proect, проэкт/proęct (слова, которые произносятся с **ударным** э)                                                                  |              `проект` | `proect`       |
