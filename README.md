...
* При обратном восстановлении используется порядок важности букв (как тут). Буква без диакритики считается той, что более важная. Если прообраз от образа слова не равен слову, то нужно использовать следующую комбинацию.
