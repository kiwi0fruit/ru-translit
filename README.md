...
| **Ф** |     **Х**      |  **Ц**  | **Ч**  |  **Ш**  |
|   F   |       Ch       |    Ç    |  Cí    |   Sh    |
| **Щ** | **КЦ, КИ, ЧИ, ЙА, ЯР** | **КТС** | **СЧ** | **САЭ, СЭ, СЕ** |
|  Scí  |  CÇ, CÍ, CíÍ, JA, ÁR   |   CTS   |   SCí  |   SAE, SE, SÉ   |
...
В ASCII-латинице-26 используется 25 букв - все, кроме Xx. В финальной юникод-латинице используются 23 буквы базовой латиницы (все кроме Xx, Qq, Ww), плюс ещё 8 букв основного алфавита Éé, Áá, Óó, Úú, Íí, Øø, Ææ, Çç и 4 буквы алфавита обеспечения обратимости в кириллицу и обратно: Ŝŝ, Ĵĵ, Čč, Ğğ. Итого: 31 + 4 букв.
...
| ко/co      | чо/cio/có | кё/ckio/ckó          | чё/cio/có     | чо/cjho/čo  |
...
| го/go      | жо/gio/gó | гё/ghio/ghó          | жё/gio/gó     | жо/gjho/ğo  |
...
| ско/sco      | що/счо/scio/scó | скё/sckio/sckó            | щё/счё/scio/scó     | що/счо/scjho/sčo  |
| скэ/scae/scæ | щэ/счэ/sce      | ске/scke/scke             | ще/сче/sce          | щэ/счэ/scjhae/sčæ |
...
| ------------ | ----------- | ------------------------- | ----------------------------------------------- | ------------- |
| кт/ct        | ц/ctj/ctí   | кть/cktj/cktí, ктъя/cktja | ць/ctj/ctí, цья/ctjja/ctjá, цъя/ctjqqja/ctíøja  | ць/ctjhj/çí  |
| кта/cta      | ца/ctia/ctá | ктя/cktia/cktá            | ця/ctia/ctá                                     | ця/ctjhia/çá |
| кту/ctu      | цу/ctiu/ctú | ктю/cktiu/cktú            | цю/ctiu/ctú                                     | цю/ctjhiu/çú |
| кто/cto      | цо/ctio/ctó | ктё/cktio/cktó            | цё/ctio/ctó                                     | цё/ctjhio/çó |
| ктэ/ctae/ctæ | цэ/cte      | кте/ckte                  | це/cte                                          | цэ/ctjhae/çæ |
| **кты/ckty** | цы/cti      | **кти/cty**               | ци/cti                                          | цы/ctjhy/çy  |
