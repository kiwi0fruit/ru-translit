...
|  Sć  |  CÇ, CÍ, CíÍ, JA, ÁR   |   CTS   |   SCí  |   SAE, SE, SÉ   |
...
В ASCII-латинице-26 используется 25 букв - все, кроме Xx. В финальной юникод-латинице используются 23 буквы базовой латиницы (все кроме Xx, Qq, Ww), плюс ещё 8 букв основного алфавита Éé, Áá, Óó, Úú, Íí, Øø, Ææ, Çç и 5 букв для обеспечения обратимости в кириллицу и обратно: Ŝŝ, Ĵĵ, Ćć, Ǵǵ, Śś. Итого: 31 + 4 букв.
