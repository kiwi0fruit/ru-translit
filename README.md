...
В ASCII-латинице-26 используется 25 букв - все, кроме Xx. В финальной юникод-латинице используются 23 буквы базовой латиницы (все кроме Xx, Qq, Ww), плюс ещё 10 букв основного алфавита Éé, Ææ, Øø, Ǿǿ, Ø̂ø̂, Íí, Áá, Óó, Úú, Çç и 5 букв алфавита обеспечения обратимости в кириллицу и обратно: Ŝŝ, Ĵĵ, Ťť, Čč, Ğğ. Итого: 33 + 5 буквы.
