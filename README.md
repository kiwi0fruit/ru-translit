...
|        | Cyrillic RegEx | Latin RegEx   | Примеры                                                                            |
| ------ | --------------:|:------------- | ---------------------------------------------------------------------------------- |
| туер/буер/конгруен/проект/.../we | `туер`&#124;`буер`&#124;`конгруен`&#124;`проект`&#124;`...` | `we` | ту**е**рный/tu**we**rnyj, ту**е**р/tu**we**r, бу**е**р/bu**we**r, про**е**кт/pro**we**kt (слова, которые должны были быть с `ye`, но произносятся с **ударным** "э") |
