...
**НАЧАЛО СТАРОГО НЕАКТУАЛЬНОГО ОПИСАНИЯ**
...
**КОНЕЦ СТАРОГО НЕАКТУАЛЬНОГО ОПИСАНИЯ**
...
* **Aa** - а
  * **IA** - я (IA., FIIA ФИЯ, RIÂ РИА RIiA, RIîA РИиА RIiiA)
* **Bb** - бэ
* **Cc** - це (C., CPU ЦПУ, CìA ЦА CiA, CîA ЦиА CiiA, CI ЦИ)
  * **Ch** - че (Ch., ChS ЧС)
* **Dd** - дэ
* **Ee** - е
  * **IE** - е (IE., IEGÊ ЕГЭ, OBSE ОБСЕ)
  * **IEO** - ё (IEO.)
  * **Ê** (AE) - э (Ê., IEGÊ ЕГЭ, ÊÊG ЭЭГ)
* **Ff** - эф
...
Возможно использование исключений типа Nèìŵ York => NY вместо NÌ, т.к. Y свободна для смысла йота в аббревиатурах.
