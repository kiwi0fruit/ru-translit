...
* Если собрать сочетание не получается (есть двусмысленность), то использовать:
  ...
  * й - **ŷ**,
  * ы - **ȳ**,
* Использовать эти три буквы с начала места неоднозначности. Заменить первую и попробовать сделать однозначно. Получилось - отлично. Не получилось - заменить следующую букву.
