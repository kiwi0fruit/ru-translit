...
| ъ/j                  |             `ъ(?=[йы\w\c])` | `j`          | *(перед согласными/й/ы или в конце слова)* онъ/onj, Муъминат/Mujminat, Муръйин/Murjyin, Чанъын/Сhanjȳn                                    |
| ъи/ji                |                    `объима` | `objima`     | *(исключения отображения; йотированные)* объимать/objimatį                                                                                |
| ъ/ĵ                  |                         `ъ` | `ĵ`          | *(не йотированные)* объизвестить/obĵizvestitį, Йонъин/Yonĵin, Чанъань/Chanĵanį                                                            |
|                      |                             |              |                                                                                                                                           |
...
| ь/į                  |      `(?<=\c)ь(?=[йы\w\c])` | `į`          | *(после согласных перед согласными/й/ы или в конце слова)* прячься/prįachįsįa, мыться/mytįsįa, конь/conį, Мурьйин/Murįŷin, Чаньын/Сhanįȳn |
| ь/î                  |                         `ь` | `î`          | *(не йотированные, просто смягченные)* костьутиль/costîutilį, грабьармия/grabîarmiįa                                                      |
|                      |                             |              |                                                                                                                                           |
| ы[еёюя] / yį[eoua]   |                   `ы[еёюя]` | `yį[eoua]`   | *(перед йотированными гласными)* белые/belyįe, бедныя/bednyįa                                                                             |
| ы/ŷ                  |               `ы(?=[эоуа])` | `yw`         | Нарва-Йыэсуу/Narva-Yȳesuu, Баймаклыаул/Bajmaklȳaul, белыйа/belyŷa, белыйя/belyŷįa                                                         |
| ыи/ŷi                |              `(?<![й\c])ыи` | `ywi`        | аыи/aywi/aŷi, сьыио/sjywio                                                                                                                |
| ыи/yi                |              `(?<=[й\c])ыи` | `yi`         | выигрывать/vyigryvatj, выискивать/vyiskivatj                                                                                              |
| ы/y                  |                         `ы` | `y`          | крыска/kryska, ыпся/ypsja, пыхтел/pyhtel, белый/belyj, выйигрывать/vyjigryvatj, байыс/bajys                                               |
|                      |                             |              |                                                                                                                                           |
| й/jj                 |                  `(?<=\c)й` | `ŷ`          | подйезд/podŷįezd, подйод/podŷod, Мурйин/Murŷin, подййод/podŷyod, аййод/ayyod                                                                      |
| й/į                  |         `(?<=ы)й(?=[\w\c])` | `į`          | белый/belyį, белыйс/belyįs                                                                                                                |
| й/ŷ                  |         `(?<=ы)й(?![\w\c])` | `ŷ`          | белыйа/belyŷa, белыйя/belyŷįa                                                                                                             |
