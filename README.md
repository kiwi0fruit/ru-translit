...
### Uniquely reversible lossless Russian to English transliteration (without use of extra letters, diacritics and non-letter spelling marks). Uniquely reversible lossless Romanization of Russian (russkaya latinica) with extended alphabet (two types of diacritics only: Êê, Ěě)
...
| **ъ** | **ы** | **ь** | **э** | **ю** | **я** | **экс** | **эх** | **экз** |
| j/ɉ   | y/ŷ   | j     | ě     | û     | â     | ěx    | ěch   | ěxz   |
| wjh   | yy    | jh    | eh    | yu/ju | ya/ja | ex    | ehch  | exz   |
...
| yu/sjyu/yju/sju  | ya/sjya/yja/sja  | eh/exz/ex/ehch/ehwch |
...
|       | j/ĵ   | sja/ɉ     | y/yâ/ŷ      | j/sjâ/jh    |

Базовый алфавит остоит из 25 букв (английский алфавит без Qq). Плюс 14 букв (Ââ,Ĉĉ,Čč,Êê,Ěě,Ĥĥ,Îî,Ɉɉ,Ĵĵ,Ôô,Šš,Ûû,Ŷŷ,Žž).  
Расширенный алфавит состоит из 38 букв. Из диакритических знаков для естественных русских языковых конструкций используются только [циркумфлекс](https://ru.wikipedia.org/wiki/%D0%A6%D0%B8%D1%80%D0%BA%D1%83%D0%BC%D1%84%D0%BB%D0%B5%D0%BA%D1%81) и [гачек](https://ru.wikipedia.org/wiki/%D0%93%D0%B0%D1%87%D0%B5%D0%BA). Дополнительно может быть использована редкая модифицированная зачеркнутая j для обозначения ъ в невозмножных позициях (Ɉɉ). Клавиатура Google её не поддерживает.
...
| --------- | --------------:|:----- | -------------------------------------------- |
| ъе/je, ъё/jo, ъи/ji, ъю/ju, ъя/ja | `(?<=\c)ъ[еёюяи]` | `(?<=\c)j[eouai]` | об**ъе**кт/ob**je**kt, из**ъя**н/iz**ja**n, м**е**ра/m**e**ra, **е**сли/**e**sli, з**я**ка/z**ya**ka/z**â**ka, Мур**ъи**н/Mur**ji**n |
| ъ/wjh/ɉ   | `ъ`            | `wjh` | он**ъ**/on**wjh**/on**ɉ**, Му**ъ**минат/Mu**wjh**minat/Mu**ɉ**minat, Чан**ъ**ань/Chan**wjh**anj/Chan**ɉ**anj, Мур**ъйи**н/Mur**wjhji**n/Mur**ɉji**n |
| | | | |
...
| ь/jh      | `ь`            | `jh`  | Чан**ь**ол/Сhan**jh**ol/Čan**jh**ol, Мур**ьй**ин/Mur**jhj**in/Mur**jhj**in, Чан**ь**ын/Сhan**jh**yn/Čan**jh**yn |
| | | | |
...
| | | | |
| й/jj/ĵ    | `(?<=[й\c])й`  | `jj`  | **йй**/**jjjj**/**ĵĵ**, под**й**ес/pod**jj**es/pod**ĵ**es, под**й**од/pod**jj**od/pod**ĵ**od, Мур**й**ин/Mur**jj**in/Mur**ĵ**in |
| й/jj/ĵ    | `й(?=й)`       | `jj`  | **йй**/**jjjj**/**ĵĵ** |
| й/jj/ĵ | `(?<=ы)й(?=[эоуае])` | `jj` | белы**й**а/bely**jj**a/bely**ĵ**a, белы**й**е/bely**jj**e/bely**ĵ**e |
| йе/jye    | `йе`           | `jye` | ба**йе**с/ba**jye**s/ba**jê**s |
| й/j       | `й`            | `j`   | белы**й**/bely**j**, **й**од/**j**od, **й**иппи/**j**ippi, ба**й**ас/ba**j**as, ба**й**яс/ba**j**yas/ba**j**âs |
...
| эч/ehwch/ěĉ | `эч`      | `ehwch`       | в**эч**ный/v**ehwch**nyj/v**ěĉ**nyj                                                |
...
| | | | |
| шч/shwch/šĉ | `шч`      | `shwch`       | **шч**ётка/**shwch**yotka/**šĉ**ôtka                                               |
...
| х/kh/ĥ | `(?=[хтсшзжцчщъьейк])х` | `kh` | с**х**од/s**kh**od/s**ĥ**od, **кх**е/**kkh**e/**kĥ**e, си**кх**/si**kkh**/si**kĥ**, ме**х**/me**kh**/me**ĥ**, мэр/mehr/měr, Муръ**х**ин/Murwjh**kh**in/Murɉ**ĥ**in, Мурь**х**ин/Murj**kh**in/Murj**ĥ**in, от**х**од/ot**kh**od/ot**ĥ**od |
