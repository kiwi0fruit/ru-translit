...
| ж  | й    | х    | ч  | ш/шч     | щ    | ъ/съя  | ы    | ь    | э/экз/экc/эх/эч       |
| -- | ---- | ---- | -- | -------- | ---- | ------ | ---- | ---- | --------------------- |
| zh | jj/j | kh/h | ch | sh/shchh | shch | wh/sja | yy/y | jh/j | eh/exz/exs/ehch/ehchh |
| ž  | ĵ/j  | ĥ/h  | č  | š/šĉ     | šč   | ŵ/sja  | ŷ/y  | jh/j | ê/êxz/êxs/êĥ/êĉ       |
...
| х/h    | `х`                   | `h`                 | **х**о**х**олок/**h**o**h**olok, в**ы**ход/v**y**hod, **х**ья/**h**jya/**h**jǎ, **х**ьан/**h**jhan/**h**ȷan |
| е/e    | `е`                   | `e`                 | в**е**к/v**e**k                                                       |
...
| экс/exs/êxs | `экс`            | `exs`               | **экс**каватор/**exs**kavator, **экс**ель/**exs**elj                  |
