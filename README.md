...
Каждый второй столбец - ASCII версия (ė - точно "мягкая"):

| Таблица А        | Е   |      | Ё   |     | Я  |    | Ю  |    | Э    |      | Ы   |    | Йо |      |
| ---------------- | --- | ---- | --- | --- | -- | -- | -- | -- | ---- | ---- | --- | -- | -- | ---- |
...
| иначе            | ie  |      | ieo |     | ia |    | iu |    | e    | e    | hy  |    | io |      |

\* ė - точно "мягкая" Е,  
\*\* è - ещё в начале слова в словах исключениях (Èuropa / Европа),  
\*\*\* ê - еще после Согласная+А или после Ы (maêstro).

| Таблица Б    | ЪЕ   | ЪЁ    | ЪЯ   | ЪЮ   | ЪИ | ЬЕ   | ЬЁ    | ЬЯ   | ЬЮ   | ЬИ   | ЬО   |
| ------------ | ---- | ----- | ---- | ---- | -- | ---- | ----- | ---- | ---- | ---- | ---- |
...
| после согласной или Ь, звучащие как в Таблице Б            | как в Таблице Б |     |
| после гласной                                              | i               |     |
