...
| е/ye | `(?<=\c[а][а])е` | `ye`          | маa**е**р/maa**ye**r |
| е/e    | `е`            | `e`           | м**е**х/m**e**h |
...
| э/we | `(?<=\c[а][а])э` | `we`          | маa**э**р/maa**we**r |
| э/ae   | `(?<=\cа?)э`   | `ae`          | м**э**р/m**ae**r, мер/mer, ма**э**р/ma**ae**r, мааэр/maaer, мааер/maayer, моаэр/moaer, в**эч**ный/v**aech**nyj |
| | | | |
