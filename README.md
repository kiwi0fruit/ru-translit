...
|   **щ**   |  **ъ**  |   **ь**   | **кс, кц, ктс** | **сч, саэ** |
| sc/scí/sč | None/ø̂ |   í/íø̂   |  cs, cts, ckts  | sc/ŝc, saê  |
...
| **Ф** |     **Х**      |  **Ц**  | **Ч**  |  **Ш**  |
|   F   |       Ch       |    Ç    |   Č    |   Sh    |
| **Щ** | **КЦ, КИ, ЧИ** | **КТС** | **СЧ** | **САЭ** |
|  SČ   |   СÇ, ĈI, ČI   |   ĈTS   |   ŜČ   |   SAÊ   |
...
В ASCII-латинице-26 используется 25 букв - все, кроме Xx. В финальной юникод-латинице используются 23 буквы базовой латиницы (все кроме Xx, Qq, Ww), плюс ещё 14 букв Éé, Êê, Øø, Ǿǿ, Ø̂ø̂, Íí, Čč, Ğğ, Ťť, Çç, Ĝĝ, Ĉĉ, Ŝŝ, Ĵĵ. Итого: 37 букв.
