...
| ъи/ji                            |                   `объима`  | `objima`                  | *(исключения отображения; йотированные)* объимать/objimatj/objimatį                                                                                     |
| ъ/wjh/ĵ                          |                         `ъ` | `wjh` / `ĵ`               | *(не йотированные)* объизвестить/obwjhizvestitj/obĵizvestitį, Йонъин/Jonwjhin/Yonĵin, Чанъань/Chanwjhanj/Chanĵanį, Муръйин/Murwjhjin/Murĵyin, Чанъын/Сhanwjhyn/Сhanĵyyn |
|                                  |                             |                           |                                                                                                                                                         |
...
| ьо / jyio / įjo                  |                 `(?<=\c)ьо` | `jyio` / `įjo`            | *(после согласных перед о)* батальон/bataljyion/batalįjon, лосьон/losjyion/losįjon, сеньор/senjyior/senįjor                                             |
| ь / jyie / įje                   |               `бельэтаж` | `beljyietazh` / `belįjetazh` | *(исключения отображения; йотированные)* бельэтаж/beljyietazh/belįjetazh                                                                                |
| ь/j/į                            |        `(?<=\c)ь(?=[\w\c])` | `j` / `į`                 | *(после согласных перед согласными или в конце слова)* прячься/pryachjsya/prįachįsįa, мыться/mytjsya/mytįsįa, конь/konj/conį                            |
| ь/jh/î                           |                         `ь` | `jh` / `î`                | костьутиль/kostjhutilj/costîutilį, грабьармия/grabjharmiya/grabîarmiįa, Мурьйин/Murjhjin/Murîyin, Чаньын/Сhanjhyn/Сhanîyyn                              |
|                                  |                             |                           |                                                                                                                                                         |
