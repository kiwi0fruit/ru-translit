...
|        | Cyrillic RegEx | Latin RegEx   | Примеры                                                                            |
| ------ | ------------:|:------------- | ---------------------------------------------------------------------------------- |
| проект/.../we(e) | `проект`&#124;`...` | `we` | про**е**кт/pro**we**kt/pro**e**kt (слова, которые должны были быть с `ye`, но произносятся с **ударным** "э") (в случае с диакритикой можно обойтись без w) |
