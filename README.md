...
Алфавит транслитерации состоит из **25** букв (английский алфавит без Qq). Минималистичная диакритика требует еще 4 символа (Ęę,Êê,Ĵĵ,Şş,Ŷŷ), но уже не нуждается в Ww. Итого **29** букв. Если делать специальную раскладку клавиатуры, то клавишу `]/Ъ` заменить на Ĵĵ, `W/Ц` заменить на Şş, `[/Х` заменить на Ŷŷ, `Q/Й` заменить на Ęę, `/?`/`.,` заменить на `"?`, `'"`/`Э` заменить на Êê,
