...
|        | Cyrillic RegEx | Latin RegEx   | Примеры                                                                            |
| ------ | --------------:|:------------- | ---------------------------------------------------------------------------------- |
| туер/буер/конгруен/проект/... | `туер`&#124;`буер`&#124;`конгруен`&#124;`проект`&#124;`...` | `ue` | туерный/tuwernyj, туер/tuwer, буер/buwer, проект/prowekt (слова, которые должны были быть с `ye`, но произносятся с "э") |
