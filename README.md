...
| --------------------------------------------------------------------------------- | ---------------------------:|:-------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ъ[еёюя]/j[eoua] (после согласных перед йотированными гласными)                    |            `(?<=\c)ъ[еёюя]` | `(?<=\c)j[eoua]`     |                      | объект/objekt, изъян/izjan                                                                                                                              |
| ъ/wj/j                                                                            |               `ъ(?=[\w\c])` | `wj`                 | `j`                  | онъ/onwjh/onj, Муъминат/Muwjminat/Mujminat                                                                                                              |
