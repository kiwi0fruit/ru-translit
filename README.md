...
| **е**           | **ё**   | **ж** | **и**   | **й** | **х** | **ч**   | **ш**       | **щ**     | 
|:---------------:|:-------:|:-----:|:-------:|:-----:|:-----:|:-------:|:-----------:|:---------:|
| е/ye/je/we(ê)   | yo/jo   | zh    | i/yi/ji | j/jj  | h/kh  | ch      | sh          | sjch(şch) |
| **ъ**           | **ы**   | **ь** | **э**   | **ю** | **я** | **экс** | **сьч**     |           |
...
|:------------------------------:|:-------------------------:|:------------------------------:|
| ye/sjye/yje/swje(sĵe)/se/we(ê) | yo/sjyo/yjo/swjo(sĵo) | i/sji/syi/aywi(aŷi)/swji(sĵi) |
| **ю/сью/ыю/съю**            | **я/сья/ыя/съя**       | **э/сэ/экс**                   |
| yu/sjyu/yju/swju(sĵu)      | ya/sjya/yja/swja(sĵa) | e/sae(sę)/ex                   |

| **й/сй/ыйа** | **съе/със/съа/съи**                       | **ы/ые/ыа/ыи**   | **ь/сье/ь/сьи** |
|:------------:|:-----------------------------------------:|:----------------:|:---------------:|
| j/sjj/yjja   | swje(sĵe)/swjs(sĵs)/swjha(sĵha)/swji(sĵi) | y/yje/ywa(ŷa)/yi | j/sjye/jh/sji  |
...
Алфавит транслитерации состоит из **25** букв (английский алфавит без Qq). Минималистичная диакритика требует еще 5 символов (Ęę,Êê,Ĵĵ,Şş,Ŷŷ), но уже не нуждается в Ww. Итого **29** букв. Если делать специальную раскладку клавиатуры, то клавишу `](Ъ)` заменить на Ĵĵ, `W(Ц)` заменить на Şş, `[(Х)` заменить на Ŷŷ, `Q(Й)` заменить на Ęę, `\|` заменить на Êê.
