...
|:------------:|:----------------------------------------------------------------------------------------------------------------- |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|    **ъи**    | **yi** (**ъи** после согласных в словарных словах-исключениях, когда и йотируется)                                | объимать/obyimatj, обйимать/obyimatjw/obyimatįꞌ, обйимоть/obyimotį, объимоть/obqqimotj/obɂimotį, объйимать/obqqyimatj/obɂyimatį (здесь логика модификации с помощью w(h) изменена только для словарных слов-исключений)                                           |
|    **ъ**     | None (после согласных перед **яёюе**), **qq** / **ɂ** (иначе)                                                     | изъян/izyan, объект/obyekt, объизвестить/obqqizvestitj/obɂizvestitį, Йонъин/Yonqqinw/Yonɂinꞌ, Сёркйосен/Siorkyosenw/Siorkyosenꞌ, онъ/onqq/onɂ, Муъминат/Muqqminat/Muɂminat, Чанъань/Chanqqanj/Chanɂanį, нъын/nqqwyn/nɂꞌyn                                        |
|    **ьо**    | **jyo...w** / **jyo...ꞌ** (**jyoh**) (**ьо** когда они **йотируются**, а это почти всегда)                                          | бульон/buljyonw/bulįyonꞌ, бульонъён/buljyohnyon/bulįŷonyon, сеньор/senjyorw/senįyorꞌ, лосьон/losjyonw/losįyonꞌ, лосьйон/losjyonww/losįyonꞌꞌ (здесь **специально для ьо** изменена логика модификации с помощью w(h))                                                                                   |
