...
|     n     |    p    |     r     |       s/ŝ       |      t      |
|   **ф**   |  **х**  |   **ц**   |      **ч**      |    **ш**    |
|     f     |   ch    | ct/ctí/cť |     c/cí/č      |     sh      |
|   **щ**   |  **ъ**  |   **ь**   | **кс, кц, ктс** | **сч, саэ** |
| sc/scí/sč | None/ø  |    í/ǿ    |  cs, cts, ckts  | sc/ŝc, saæ  |
...
| **Ф** |     **Х**      |  **Ц**  | **Ч**  |  **Ш**  |
|   F   |       Ch       |    Ç    |  Cí    |   Sh    |
| **Щ** | **КЦ, КИ, ЧИ, ЙА, ЯР** | **КТС** | **СЧ** | **САЭ, CЭ, СЕ** |
|  Scí  |  СÇ, CÍ, CíÍ, JA, ÁR   |   CTS   |   SCí  |   SAE, SE, SÉ   |
...
В ASCII-латинице-26 используется 25 букв - все, кроме Xx. В финальной юникод-латинице используются 23 буквы базовой латиницы (все кроме Xx, Qq, Ww), плюс ещё 8 букв основного алфавита Éé, Áá, Óó, Úú, Íí, Øø, Ææ, Çç и 5 букв алфавита обеспечения обратимости в кириллицу и обратно: Ŝŝ, Ĵĵ, Ťť, Čč, Ğğ. Итого: 31 + 5 букв.
...
| ------------ | ----------- | ------------------------- | ----------------------------------------------- | ------------- |
| кт/ct        | ц/ctj/ctí   | кть/cktj/cktí, ктъя/cktja | ць/ctj/ctí, цья/ctjja/ctjá, цъя/ctjqqja/ctíøja  | ць/ctjhj/cťí  |
...
| ктэ/ctae/ctæ | цэ/cte      | кте/ckte                  | це/cte                                          | цэ/ctjhae/cťæ |
| **кты/ckty** | цы/cti      | **кти/cty**               | ци/cti                                          | цы/ctjhy/cťy  |
