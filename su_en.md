...
*Дополнительные опциональные правила*: **чж - cg[eij]**, в аббревиатуры и инициалы идёт как **Ch** (Cgiunkhua), **кж - ckg[eij]**. Может, стоит ввести и **кс - x, cs (на стыке морфем)**. Xenija вопреки всему даёт инициал **C.** Так же можно писать **кз** как **xz** для словарных исключений (exzamen). Ещё можно писать **кв** как **cqu** (cquity), а **ф** как **ph** в некоторых словарных словах латинского происхождения.  
...
### (Вариант с x для кс, eo вместо io, qv для некоторых кв, xz для некоторых кз)
