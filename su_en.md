...
*Ещё* можно для **ё после согласных** (но не после йота) использовать **eo** вместо **io** (а **eo** после согласных кроме **h** и **k** становится **ieo**: lieo/лео, gheo/гео). Так будет менее логично, но зато чуть более этимологично и будет лучшее переиспользование уже обученных нейросетей в голове.
