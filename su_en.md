...
**После Ч,Ш,Г,К "И" пишется как Y: ChY,ShY,GY,CY.**
...
| **Ф** |     **Х**      |  **Ц**  | **Ч**  |  **Ш**  |
|   F   |       H        |   CI    |  Ch    |   Sh    |
| **Щ** | **КЦ, КИ, КИИ, КЫ, ШИ, ШЫ, ЦИ, ЙА, ЯР, ФИО, ЙИ**   | **КТС, НХЛ** | **СЧ** | **САЭ, СЭ, СЕ** |
|  Sch  | CCI, CY, CYY, CYI, ShY, ShYI, CII, JIA, JAR, FIO, JII |   CTS, NHL   |   SCh  |   SAE, SE, SJE  |
