...
| **Ф** |     **Х**      |  **Ц**  | **Ч**  |  **Ш**  |
|   F   |       H        |   Ce    |  Ch    |   Sh    |
| **Щ** | **КЦ, КИ, ЦИ, ЙА, ЯР, ФИО, ЙИ**  | **КТС** | **СЧ** | **САЭ, СЭ, СЕ** |
|  Sch  | CCe, CI, CeIY, JIA, JAR, FIO, JIIY |   CTS   |   SCh  |   SAE, SE, SJE  |
...
IY вместо I применяется в ситуации если заменив её на l (строчную L) мы получим слово из трех и более букв, в котором только первая буква заглавная (формализация ситуации путаницы с Ll).
