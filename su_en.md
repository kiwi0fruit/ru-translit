...
Когда требуется пометить всего одно слово, то это можно сделать с помощью точки в начале слова.

On vypil butylcu .Coca-Cola i zagovoril \`Hello, do you speak English?\`
