...
Когда требуется пометить всего одно слово - до следующего знака препинания, то это можно сделать с помощью одной запятой в начале слова (``" ,[\w]"``). А нужно пометить кусок текста до следующего пробельного символа, то это можно сделать с помошью всего одной точки (``" .[\w]"``). А с помощью двух точек можно пометить кусок текста до конца предложения (``" ..[\w]"``).
