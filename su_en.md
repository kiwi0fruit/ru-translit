...
**Слова на латинице из других языков** можно писать, экранируя с помощью ``" ..[\w]"`` и ``"[\w].. "`` (или закрывающий ``"[\W] .. "`` если экранируемый текст оканчивается не на букву-цифру).

Когда требуется пометить всего одно слово - до следующего знака препинания, то это можно сделать с помощью одной запятой в начале слова. А если же нужно пометить кусок текста до следующего пробельного символа, то это можно сделать с помошью всего одной точки.
...
..Hello... no. .. => Hello... no. => ..Hello... no. ..

..Hello? .. => Hello? => ..Hello? ..

..Hello... да no. .. => ..Hello... да no. .. => ..Hello... да no. .. (экранирующие точки нельзя убирать, т.к. текст не полностью на латинице)
